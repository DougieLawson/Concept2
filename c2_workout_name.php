...
if (isset($_POST['submit'])) {
	extract($_POST);
	$wn = mysql_escape_string($wn);
	echo "<pre>";
	$start = $start_date." 00:00:00";
	$end = $end_date." 23:59:59";
	$selrow = "SELECT date_time , workout_name , distance , elapsed , stroke_rate , avg_HR , pace , cal_per_hour , watts FROM C2_log_row WHERE date_time BETWEEN '".$start."' AND '".$end."' AND workout_name like '".$wn."%'  ORDER BY date_time ASC;";
	$line=1;
	$dailytot=0;
...
#		$restline++;
	...
	$end_cal->writeScript(); ?>
        workout name:<input type=text name=wn>
