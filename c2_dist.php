...
if (isset($_POST['submit'])) {
	...
	$end = $end_date." 23:59:59";
        $dist = $dist + 0;
	$selrow = "SELECT date_time , workout_name , distance , elapsed , stroke_rate , avg_HR , pace , cal_per_hour , watts FROM C2_log_row WHERE date_time BETWEEN '".$start."' AND '".$end."' AND distance = $dist ORDER BY date_time ASC;";
	$line=1;
	$dailytot=0;
...
#		$restline++;
	...
	$end_cal->writeScript(); ?>
        distance:<input type=text name=dist>
